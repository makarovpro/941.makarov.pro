...
//delete 1c props
	$arPropsToDelete = array("CML2_TAXES", "CML2_BASE_UNIT", "CML2_TRAITS", "CML2_ATTRIBUTES", "CML2_ARTICLE", "CML2_BAR_CODE", "CML2_FILES", "CML2_MANUFACTURER");
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/quick/index.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
}
?>