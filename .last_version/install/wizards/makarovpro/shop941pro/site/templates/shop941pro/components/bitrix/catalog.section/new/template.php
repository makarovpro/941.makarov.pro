...
<div class="products group">
 <h2><?=GetMessage("CR_TITLE_NEWPRODUCT")?></h2>
...
<div class="hover"><a class="ajax" rel="nofollow" href="<?=SITE_DIR?>quick/?SECTION_ID=<?=$arItem["IBLOCK_SECTION_ID"]?>&amp;ELEMENT_ID=<?=$arItem["ID"]?>"><span><?=GetMessage("CR_TITLE_QUICK")?></span></a></div>
	...
	<h3><?=$arItem["NAME"]?></h3>
     ...
     <div class="price"><a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><span>
              ...
              <?=$arPrice["PRINT_VALUE"]?>
                            ...
                            ?><? if ($arItem["PROPERTIES"]["ED_IZM"]){?>/<?=$arItem["PROPERTIES"]["ED_IZM"]["VALUE"];?><?}?></span></a>
     </div>
