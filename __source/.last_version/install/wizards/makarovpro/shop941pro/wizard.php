...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "shop941pro";
	}
}
...
function InitStep()
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			if (in_array($templateID,  array("shop941pro")))
			{
				$wizard->SetCurrentStep("site_settings");
				$wizard->SetVar("templateID", "shop941pro");
			}
			else
				$wizard->SetVar("templateID", "shop941pro");
		}
	...
	function ShowStep()
	{
		...
		if (in_array("shop941pro", array_keys($arTemplates)))
		{
			$arTemplateOrder[] = "shop941pro";
		}
		

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "shop941pro", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("shop941pro"))) $defaultTemplateID = "shop941pro";
		...
		$arTemplateInfo = array(
			"shop941pro" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/shop941pro/images/".LANGUAGE_ID."/preview.png",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/shop941pro/images/".LANGUAGE_ID."/screen.png",
			),
			
		);


	//	$this->content .= "<input type='hidden' value='shop941pro' name='templateID' id='templateID'>";//$this->ShowInputField('hidden', 'templateID', array("id" => "templateID", "value" => "shop941pro"));
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		if(COption::GetOptionString("shop941pro", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		if ($wizard->GetVar("templateID") == "shop941pro")
		{
			$arSocNetsValues["facebook"] = COption::GetOptionString("shop941pro", "shopFacebook", GetMessage("WIZ_SHOP_FACEBOOK_DEF"), $siteID);
			$arSocNetsValues["twitter"] = COption::GetOptionString("shop941pro", "shopTwitter", GetMessage("WIZ_SHOP_TWITTER_DEF"), $siteID);
			$arSocNetsValues["vk"] = COption::GetOptionString("shop941pro", "shopVk", GetMessage("WIZ_SHOP_VK_DEF"), $siteID);
			$arSocNetsValues["google"] = COption::GetOptionString("shop941pro", "shopGooglePlus", GetMessage("WIZ_SHOP_GOOGLE_PLUS_DEF"), $siteID);
		}
		else
		{
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("shop941pro", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				...
				//"installEshopApp" => COption::GetOptionString("shop941pro", "installEshopApp", "Y", $siteID),	
			)
		);
...
class CatalogSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"catalogSubscribe" => (isset($arSubscribe[$siteID])) ? ($arSubscribe[$siteID]['use'] == "Y" ? "Y" : false) : "Y",//COption::GetOptionString("shop941pro", "catalogSubscribe", "Y", $siteID),
				"catalogView" => COption::GetOptionString("shop941pro", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("shop941pro", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("shop941pro", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("shop941pro", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("shop941pro", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("shop941pro", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("shop941pro", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("shop941pro", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("shop941pro", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("shop941pro", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("shop941pro", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("shop941pro", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("shop941pro", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("shop941pro", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("shop941pro", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("shop941pro", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("shop941pro", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("shop941pro", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("shop941pro", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("shop941pro", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("shop941pro", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("shop941pro", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("shop941pro", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("shop941pro", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("shop941pro", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("shop941pro", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("shop941pro", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if ($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("shop941pro", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("shop941pro", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
===*/
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("shop941pro", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("shop941pro", "wizard_installed", "N", $siteID) != "Y")
						{
